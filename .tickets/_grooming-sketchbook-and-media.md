...
### SB4 — Ideas become subjects: `SubjectKind` gains `'idea'`, "Practice this" from an idea  `[merged: feat-0014, PR #26, 2026-09-03 — all criteria unit; resolveSubject stayed synchronous]`
**Tier:** T1
**Depends on:** SB3b
...
### SB5 — Search: Postgres full-text + filter grammar, search box on the stream  `[merged: feat-0015, PR #27, 2026-09-03 — all four criteria closed incl. deployed; search_tsv is unmapped by design; CI caught a fixture clash create_all-based tests can't have]`
**Tier:** T1
...
### SB7 — Web MIDI quick capture → `.mid` attachment  `[merged: feat-0017, PR #29, 2026-09-03 — criteria 1-4 unit and closed; encoder round-tripped through the backend's own mido parser; criterion 5 (hardware) still OPEN for attended verification]`
...
### PV2 — Job worker: queued runs → extractor registry → properties, embedded in the api process  `[merged: feat-0009, PR #19, 2026-09-03 — deployed check MET: enqueued run succeeded in 3s and wrote its property]`
...
### PV3 — `midi-features` extractor + auto-enqueue on MIDI asset upload + properties panel  `[merged: feat-0010, PR #20, 2026-09-03 — deployed check MET: A minor @ 0.924 from a real .mid; merged red, repaired by fix-0006]`
